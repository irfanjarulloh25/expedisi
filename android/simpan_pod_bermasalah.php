...
if ($data_paket) {
    ...
    $nama_foto = "MSL_" . $no_resi . "_" . time() . ".jpg";
        ...
        try {
            ...
            if (mysqli_num_rows($cek_recent) == 0) {
                $sql_scan = "INSERT INTO scan_paket (paket_id, jenis_scan, kurir_id, scan_time) 
                             VALUES ('$id_paket', 'bermasalah', '$kurir_id', NOW())";
                mysqli_query($conn, $sql_scan);
            }

            mysqli_commit($conn);
            echo "Berhasil Simpan Laporan Masalah";
